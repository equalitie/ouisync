...
abstract class AbstractFileProvider : ContentProvider() {
    ...
    protected open fun getFileName(uri: Uri): String? = uri.lastPathSegment

    protected open fun getDataLength(uri: Uri): Long = uri.pathSegments[0].toLongOrNull() ?: AssetFileDescriptor.UNKNOWN_LENGTH
