...
class LocatorTest {
    ...
    fun testJoin() {
        ...
        assertEquals(Locator(repo = "foo", path = "bar/baz"), Locator(repo = "foo", path = "bar").join("baz"))
    }
    ...
    fun testParent() {
        ...
        assertEquals(Locator(repo = "foo", path = "bar"), Locator(repo = "foo", path = "bar/baz").parent)
    }
    ...
    fun testIsChildOf() {
        ...
        assertTrue(Locator(repo = "foo", path = "bar/baz").isChildOf(Locator(repo = "foo", path = "bar")))
        ...
        assertFalse(Locator(repo = "foo", path = "bar/baz").isChildOf(Locator(repo = "foo", path = "bar/ba")))
        assertFalse(Locator(repo = "foo", path = "bar/baz.jpg").isChildOf(Locator(repo = "foo", path = "bar/baz")))
    }
}
