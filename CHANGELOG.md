...
- Re-enable [GSO](https://docs.kernel.org/networking/segmentation-offloads.html) on Android now that [this issue](https://github.com/quinn-rs/quinn/issues/2246) has been resolved
